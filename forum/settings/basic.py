...
APP_LOGO = Setting('APP_LOGO', '/upfiles/shaastra.png', BASIC_SET, dict(
...
APP_TITLE = Setting('APP_TITLE', u'Shaastra Forums', BASIC_SET, dict(
label = _("Application title"),
help_text = _("The title of your application that will show in the browsers title bar")))

APP_SHORT_NAME = Setting(u'APP_SHORT_NAME', 'Shaastra', BASIC_SET, dict(
