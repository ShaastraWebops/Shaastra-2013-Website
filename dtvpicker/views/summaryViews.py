...
def dtvSummaryByEvent(request):
    ...
    if currentUserProfile.is_core:
        ...
        return render_to_response("dtvpicker/SummaryPages/CoreDTVSummary_ByEvent.html", locals(), context_instance = RequestContext(request))
        ...
        Event_SubEventList = SubEvent.objects.filter(event = requestedEvent).order_by('start_date_and_time') # List of sub-events under
                                                                                                             # requestedEvent
        happenings.append((requestedEvent, Event_SubEventList))
        return render_to_response("dtvpicker/SummaryPages/CoordDTVSummary_ByEvent.html", locals(), context_instance = RequestContext(request))
...
def dtvSummaryByVenue(request):
    ...
    if currentUserProfile.is_core:
        ...
        return render_to_response("dtvpicker/SummaryPages/CoreDTVSummary_ByVenue.html", locals(), context_instance = RequestContext(request))
...
def dtvSummaryByDate(request):
    ...
    if currentUserProfile.is_core:
        ...
        return render_to_response("dtvpicker/SummaryPages/CoreDTVSummary_ByDate.html", locals(), context_instance = RequestContext(request))
