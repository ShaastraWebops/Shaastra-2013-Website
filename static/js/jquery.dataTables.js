...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		return this.each(function() {
			...
			_fnMap( oSettings, oInit, "bBootstrapUI");
			...
			else if ( oInit.bBootstrapUI )
			{
				/* Imitate the jquery UI behavior for Bootstrap.css */
				$.extend( oSettings.oClasses, DataTable.ext.oBootstrapClasses );
			
				if ( oInit.sDom == DataTable.defaults.sDom )
				{
					oSettings.sDom = "<'row'<'span8'l><'span8'f>r>t<'row'<'span8'i><'span8'p>>";
				}
				if ( oInit.sPaginationType == DataTable.defaults.sPaginationType)
				{
					oSettings.sPaginationType = "bootstrap";
				}
			}
			else
			{
	...
	$.extend( DataTable.ext.oBootstrapClasses, DataTable.ext.oStdClasses, {
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"bootstrap": {
			...
			"fnUpdate": function ( oSettings, fnDraw ) {
				var iListLength = 5;
				var oPaging =  function (oSettings)
				{
					return {
